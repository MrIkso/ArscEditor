...
public final class ResourceHelper {
   ...
   /* static {
     ...
     */
    public static BinaryResourceValue.Type getColorType(String value) {
        if (value != null && value.startsWith("#")) {
            switch (value.length()) {
                case 4:
                    return BinaryResourceValue.Type.INT_COLOR_RGB4;
                case 5:
                    return BinaryResourceValue.Type.INT_COLOR_ARGB4;
                case 7:
                    return BinaryResourceValue.Type.INT_COLOR_RGB8;
                case 9:
                    return BinaryResourceValue.Type.INT_COLOR_ARGB8;
            }
        }
        return BinaryResourceValue.Type.INT_COLOR_ARGB8;
    }
